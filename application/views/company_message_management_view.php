                ...
                <section class="panel">
                    <div class="panel-body profile-information">
                        <div class="col-md-12" style="padding-top: 10px; padding-bottom: 20px;">
                            <div class="row">
                                <div class="col-md-6">
                                    <h4 class="page-title-style">List of Messages</h4>
                                </div>
                                <div class="col-md-6 form-inline card-toolbar">
                                    <button class="btn btn-primary btn-md pull-right" id="add-new-message-modal" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus" aria-hidden="true"></i> Add New Message</button>
                        ...
                        <div class="col-md-12" style="background: white; padding-bottom: 10px;">
                            ...
                            <table data-toggle="table" data-url="get_message_list/<?php echo $company_name;?>" data-search="false" data-toolbar="#toolbar" data-pagination="true">
                                <thead>
                                    <tr>
                                        <th data-field="created_date">Created Date</th>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <textarea class="form-control" rows="10" name="message-content" id="message-content" style="width: 100%; color: black;" placeholder="Message"></textarea>
                </div>
            </div>
