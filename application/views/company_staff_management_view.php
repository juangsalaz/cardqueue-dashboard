        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu extended logout">
                ...
                <li>
                    Company Management
                    <ul>
                        <li><a href="<?php echo base_url()?>index.php/company/hq_management">HQ Management</a></li>
                        <li><a href="<?php echo base_url()?>index.php/company/branch_management">Branch Management</a></li>
                        <li><a href="<?php echo base_url()?>index.php/company/staff_management">Staff Management</a></li>
                    </ul>
                </li>
                ...
                <section class="panel">
                    ...
                    <div class="panel-body profile-information">
                        <div class="col-md-6">
                            <div class="form-inline">
                                <div class="form-group">
                                    ...
                                    ?>
                                    <input type="hidden" id="new-staff-company" class="form-control" style="width: 300px;" value="<?php echo $company_name;?>">
                                    <input type="hidden" id="new-staff-license-number" class="form-control" style="width: 300px;" value="<?php echo $license_number;?>">
                                    <input type="email" id="new-staff-email" class="form-control" placeholder="Enter new staff email address" style="width: 300px;">
                                    <input type="hidden" id="new-staff-password" class="form-control" style="width: 300px;" value="<?php echo uniqid();?>">
                                </div>
                                <div class="form-group">
                                    <button class="btn btn-primary" id="new-staff-btn">Submit</button>
                                </div>
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            <div class="col-md-6">
                                <table id="staff-list-table" class="display table table-bordered table-striped"></table>
                            </div>
                          </div>
                        </div>
                    </div>
...
<script>
var $table = $('#staff-list-table');
var company_name = $("#new-staff-company").val();
$table.bootstrapTable({
    url: "get_staff_list/"+company_name,
    search: true,
    pagination: true,
    sortOrder: 'desc',
    sortName: 'name',
