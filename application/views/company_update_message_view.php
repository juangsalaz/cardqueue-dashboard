                    ...
                    <div class="panel-body profile-information">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control" name="message-d" id="message-id" style="width: 100%;" value="<?php echo $message_id;?>">
                                ...
                                <input type="text" class="form-control" name="message-title" id="message-title" style="width: 100%;" placeholder="Title" value="<?php echo $update_data->title;?>">
                            </div>
                            <div class="form-group">
                                <textarea class="form-control" rows="10" cols="200" name="message-content" id="message-content" style="width: 100%; color: black;" placeholder="Message"><?php echo $update_data->message;?></textarea>
                            </div>
                            <div class="form-group">
                                <a href="<?php echo base_url()?>index.php/company/messages" class="btn btn-warning">Cancel</a>
                                <button class="btn btn-primary" id="message-update-btn">Update</button>
                            </div>
                        </div>
                    </div>
                </section>
