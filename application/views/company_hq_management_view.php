                    ...
                    <div class="panel-body profile-information">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="company_name" class="form-control" readonly="readonly" value="<?php echo $company_name;?>">
                            </div>
                            <div class="form-group">
                                <label>Company License Number</label>
                                <input type="text" id="company_license_number" class="form-control" readonly="readonly">
                            </div>
                            <div class="form-group">
                                <label>Joined Since</label>
                                <input type="text" id="join_date" class="form-control" readonly="readonly">
                            </div>
                            <div class="form-group">
                                <label>Merchant Account ID</label>
                                <input type="text" id="merchant_account_id" class="form-control" readonly="readonly">
                            </div>
                            <div class="form-group">
                                <label>Merchant Encryption Key</label>
                                <input type="text" id="merchant_encryption_key" class="form-control" readonly="readonly">
                            </div>
                            <div class="form-group">
                                <label>Display Name (max 20 char)</label>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" id="company_address" class="form-control"></textarea>
                            </div>
                            <div class="form-group">
                                <label>Phone</label>
...
$.ajax(settings).done(function (response) {
    console.log(response.data.data.Branches[0].id);
    $("#company_name").val(response.data.data.Branches[0].id);
